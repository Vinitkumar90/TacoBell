...
const MenuItem = ({ item,show = true }) => {
  ...
  return (
    <div
      ...
      className="flex  mb-4 p-2 border-b-2 border-gray-100"
    >
      ...
      <div className="relative">
        ...
        {show && (
          <button
            className="bg-slate-50 rounded-md px-8 py-2 text-sm absolute top-19 left-3 z-40
